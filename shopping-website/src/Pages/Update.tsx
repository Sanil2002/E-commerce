    ...
    <div>
      ...
      <div>
        <div className="text-center">
          <h1 className="p-4 justify-center bg-gradient-to-r from-black via-yellow-300 to-black bg-clip-text text-xl font-extrabold text-transparent sm:text-5xl">UPDATE</h1>
        </div>
        <div className="pl-11 gap-9 w-full md:w-1/2 xl:w-1/3 top-0 right-0 left-0 flex ">

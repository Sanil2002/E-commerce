...
export function Navbar() {
  ...
  return (
    <NavbarBs sticky="top" className="bg-yellow-300 shadow-sm mb-3 pl-4 pr-8">
      <Container className="relative p-4 flex justify-between items-center">
        <img src={logo} alt="logo" className="h-20 w-20" />
        {/* <NavbarBs.Toggle aria-controls='basic-navbar-nav' /> */}
          <Nav className='md:flex-grow flex items-center test-sm me-auto'>
            <Nav.Link
              className="pl-5 inline-block p-3 text-2xl font-semibold text-gray-800 hover:text-gray-600 transition-colors duration-300 hover:-translate-y-2"
              to="/"
              as={NavLink}>
              Home
            </Nav.Link>
